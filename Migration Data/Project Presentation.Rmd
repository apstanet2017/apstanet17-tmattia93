...
* Proportion of racial groups (2010 - 2015)
...
```{r, echo=F}
image1_path <- '~/Dropbox/github/Migration Data/texas.png'
image1 <-readPNG(image1_path, native=T, info=F)
include_graphics(image1_path)
```
...
```{r, echo=F}
image2_path <- '~/Dropbox/github/Migration Data/colorado.png'
image2 <-readPNG(image2_path, native=T, info=F)
include_graphics(image2_path)
```
