...
county_fips <- read_dta('~/Dropbox/Networks/Final Paper/Covariate/countyfips.dta')
...
coordinates <-read.csv('~/Dropbox/Networks/Final Paper/Covariate/countylatlong.csv')
county_fips <-merge(county_fips, coordinates, by=c("fips_complete"))

#Income Data by Year
income_2009 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/income2009.csv')
income_2010 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/income2010.csv')
income_2011 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/income2011.csv')
income_2012 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/income2012.csv')
income_2013 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/income2013.csv')
income_2014 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/income2014.csv')
income_2015 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/income2015.csv')
...
county_fips <- Reduce(function(x, y) merge(x, y, by="fips_complete"), list(county_fips, income_2009, income_2010, income_2011, income_2012, income_2013, income_2014, income_2015))

#Unemployment
#2009 
unemployment_2009 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/unemployment2009.csv', stringsAsFactors = F)
...
#2010
unemployment_2010 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/unemployment2010.csv')
...
#2011
unemployment_2011 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/unemployment2011.csv')
...
#2012
unemployment_2012 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/unemployment2012.csv')
...
#2013
unemployment_2013 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/unemployment2013.csv')
...
#2014
unemployment_2014 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/unemployment2014.csv')
...
#2015
unemployment_2015 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/unemployment2015.csv')
...
county_fips <- Reduce(function(x, y) merge(x, y, by="fips_complete"), list(county_fips, unemployment_2009, unemployment_2010, unemployment_2011, unemployment_2012, unemployment_2013, unemployment_2014, unemployment_2015))

#Eductional attainment 
#2009
education_2009 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/education_2009.csv')
...
#2010
education_2010 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/education_2010.csv')
...
#2011
education_2011 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/education_2011.csv')
...
#2012
education_2012 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/education_2012.csv')
...
#2013
education_2013 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/education_2013.csv')
...
#2014
education_2014 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/education_2014.csv')
...
#2015
education_2015 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/education_2015.csv')
...
#Merge with master data set
county_fips <- Reduce(function(x, y) merge(x, y, by="fips_complete"), list(county_fips, education_2009, education_2010, education_2011, education_2012, education_2013, education_2014, education_2015))

#Poverty level
#2009
poverty_2009 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/poverty2009.csv')
...
#2010
poverty_2010 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/poverty2010.csv')
...
#2011
poverty_2011 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/poverty2011.csv')
...
#2012
poverty_2012 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/poverty2012.csv')
...
#2013
poverty_2013 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/poverty2013.csv')
...
#2014
poverty_2014 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/poverty2014.csv')
...
#Merge with master data set 
county_fips <- Reduce(function(x, y) merge(x, y, by="fips_complete"), list(county_fips, poverty_2009, poverty_2010, poverty_2011, poverty_2012, poverty_2013, poverty_2014))

#Race
#2009
race_2009 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/race_2009.csv')
...
#2010
race_2010 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/race2010.csv')
...
#2011
race_2011 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/race2011.csv')
...
#2012
race_2012 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/race2012.csv')
...
#2013
race_2013 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/race2013.csv')
...
#2014
race_2014 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/race2014.csv')
...
#2015
race_2015 <- read.csv('~/Dropbox/Networks/Final Paper/Covariate/race2015.csv')
...
#Merge with master data set 
county_fips <- Reduce(function(x, y) merge(x, y, by="fips_complete"), list(county_fips, race_2009, race_2010, race_2011, race_2012, race_2013, race_2014, race_2015))

#Latino population
#2010
population_2010 <-read.csv('~/Dropbox/Networks/Final Paper/Covariate/population2010.csv')
...
#2011
population_2011 <-read.csv('~/Dropbox/Networks/Final Paper/Covariate/population2011.csv')
...
#2012
population_2012 <-read.csv('~/Dropbox/Networks/Final Paper/Covariate/population2012.csv')
...
#2013
population_2013 <-read.csv('~/Dropbox/Networks/Final Paper/Covariate/population2013.csv')
...
#2014
population_2014 <-read.csv('~/Dropbox/Networks/Final Paper/Covariate/population2014.csv')
...
#2015
population_2015 <-read.csv('~/Dropbox/Networks/Final Paper/Covariate/population2015.csv')
...
#Merge with master data set 
county_fips <- Reduce(function(x, y) merge(x, y, by="fips_complete"), list(county_fips, population_2010, population_2011, population_2012, population_2013, population_2014, population_2015))
